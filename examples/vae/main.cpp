...
int main()
{
   ...
   cv::Mat genImage = mrcv::neuralNetworkAugmentationAsMat(imagesPath.u8string(), height, width, 200, 2, 1400, 32, 3E-4);
   ...
   mrcv::semiAutomaticLabeler(colorGenImage, height, width, resultPath.u8string(), modelPath.u8string(), classPath.u8string());
